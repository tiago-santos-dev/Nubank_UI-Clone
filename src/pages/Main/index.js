...
const Main = () => (
  ...
  >
    ...
    <Image
      ...
      resizeMode="contain"
    />
    <Text style={styles.welcome}>Tiago, Seja bem-vindo ao Template Básico!</Text>
    <Text style={styles.instructions}>Hello, Essa é a tela principal da sua aplicação =)</Text>
